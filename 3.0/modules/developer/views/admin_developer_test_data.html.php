...
<script type="text/javascript">
  $("#g-generate-test-data").ready(function() {
    ...
    <?php if (!empty($form["generate_albums"])): ?>
      $("#g-generate-albums").click();
    <?php endif ?>
    <?php if (!empty($form["generate_photos"])): ?>
      $("#g-generate-photos").click();
    <?php endif ?>
    <?php if (!empty($form["generate_comments"])): ?>
      $("#g-generate-comments").click();
    <?php endif ?>
    <?php if (!empty($form["generate_tags"])): ?>
...
<fieldset>
  <ul>
    ...
    <li <?php if (!empty($errors["albums"])): ?> class="g-error"<?php endif ?>>
      <fieldset>
        ...
        <?php foreach (array(1, 10, 50, 100, 500, 1000) as $number): ?>
      ...
      <?php if (!empty($errors["albums"]) && $errors["albums"] == "numeric"): ?>
        <p class="g-error"><?= t("Number to create must be numeric") ?></p>
      <?php endif ?>
    </li>
    <li <?php if (!empty($errors["photos"])): ?> class="g-error"<?php endif ?>>
      <fieldset>
      ...
      <?php if (!empty($errors["photos"]) && $errors["photos"] == "numeric"): ?>
        <p class="g-error"><?= t("Number to create must be numeric") ?></p>
      <?php endif ?>
    </li>
    <?php if(!empty($comment_installed)): ?>
    <li <?php if (!empty($errors["comments"])): ?> class="g-error"<?php endif ?>>
      <fieldset>
      ...
      <?php if (!empty($errors["comments"]) && $errors["comments"] == "numeric"): ?>
        <p class="g-error"><?= t("Number to create must be numeric") ?></p>
      <?php endif ?>
    </li>
    <?php endif ?>
    <?php if(!empty($tag_installed)): ?>
    <li <?php if (!empty($errors["tags"])): ?> class="g-error"<?php endif ?>>
      <fieldset>
      ...
      <?php if (!empty($errors["tags"]) && $errors["tags"] == "numeric"): ?>
        <p class="g-error"><?= t("Number to create must be numeric") ?></p>
      <?php endif ?>
    </li>
    <?php endif ?>

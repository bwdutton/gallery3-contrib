...
<?php /* Placeholder for infromation in mosaic view. */ ?>
...
$(window).load(function () {
  pearInit( {
    ...
    mosaicEffect: "<?php $mosaic_effect = module::get_var("th_pear4gallery3", "mosaic_effect", "blind"); if ($mosaic_effect == "none") print ""; else print $mosaic_effect; ?>",
...
<?php if (module::get_var("th_pear4gallery3", "sidebar_view") != ''): ?>
